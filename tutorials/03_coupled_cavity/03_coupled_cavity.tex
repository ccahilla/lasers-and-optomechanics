...
calculate the \textit{power-recycling gain}, 
calculate the \textit{coupled-cavity pole},
and build a \textit{sensing matrix} for our two degrees of freedom $\phi_1$ and $\phi_2$.
...
\textcolor{Mahogany}{\textbf{1. Write the second cavity reflectivity, gain, and transmission expressions $r(\phi_2), g(\phi_2), t(\phi_2)$, using Equations~\ref{eq:fp_refl}, \ref{eq:fp_cav}, and \ref{eq:fp_trans}, in terms of $r_2,r_3, t_2, t_3,$ and $\phi_2$}}.

\textcolor{Mahogany}{\textbf{2. Write the compound cavity reflectivity, gain, and transmission expressions $r(\phi_1,\phi_2), g_1(\phi_1,\phi_2), t(\phi_1,\phi_2)$ in terms of $r_1,t_1,\phi_1$, and your expressions from (1)}}.
Here $g_1$ is used to emphasize this is the gain for the first cavity.
