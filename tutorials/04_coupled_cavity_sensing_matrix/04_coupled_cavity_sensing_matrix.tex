...
\noindent \textbf{Figure 1:} Coupled-cavity interferometer, with three mirrors aligned and carrier plus one set of RF sidebands incident.  Also labeled is the REFL and POP fields, standing for the reflection and pick-off ports.
